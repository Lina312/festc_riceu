...
int                      numNCMFileItems = 118; //88+9+3+18 riceu added
...
static int               epicVarsPos[] = {15,16,18,19,34,24,26,27,28,43,
                                          ...
                                          17,97,98,99,100,101,102,103,
                                          104,105,106,107,108,109,110,
                                          111,112,113,114,115,116,117};  //41+9(riceu add) vars




int                      numEpicVars = 72;  //41+9+4+18(riceu add)
...
const Name variableNamesM[ ] = { "DN", "DN2", "HMN", "NFIX", "GMN", "YW", "FPO", "FPL", "MNP", "L1_DEP", 
                                 ...
                                 "FBARE","NINX","NINO","NIN2","HONO","DENO","DEN2","TONO","TON2","TONX","AVOL","FNO","FNO3","FNH3",
                                 "L1_PFAC","L2_PFAC","L3_PFAC","L4_PFAC","L5_PFAC","L6_PFAC","L7_PFAC","L8_PFAC","L9_PFAC","L10_PFAC","L3_DEP","L4_DEP","L5_DEP","L6_DEP","L7_DEP","L8_DEP","L9_DEP","L10_DEP" };  //41+9+4(RICEU ADD) vars
...
const Name variableUnitsM[ ] = { "kg/ha", "kg/ha", "kg/ha", "kg/ha", "kg/ha", "ton/ha","kg/ha", "kg/ha", "kg/ha", "m",
                                 ...
                                 "fraction","kg/ha","kg/ha","kg/ha","kg/ha","kg/ha","kg/ha","kg/ha","kg/ha","kg/ha","kg/ha",
                                 "kg/ha","kg/ha","kg/ha","None","None","None","None","None","None","None","None","None","None","m","m","m","m","m","m","m","m" }; //41+9+4 items riceu
...
const Line variableDescriptionsM[ ] = { "N-NO3 Denitrification", "N-N2O from NO3 Denitrification", "OC Change by Soil Respiration", "N Fixation", "N Mineralized",
                                        ...
                                        "Bare Land Fraction for Wind Erosion","nitrification NOx","nitrification NO","nitrification N2O","HONO","denitrification NO","denitrification N2O",
                                        "total NO","total N2O","total NOX","N-Volatilization","N-Organic Fertilizer","N-Nitrate Fertilizer","N-Ammonia Fertilizer",
                                        "Layer1 PFACTOR","Layer2 PFACTOR","Layer3 PFACTOR","Layer4 PFACTOR","Layer5 PFACTOR","Layer6 PFACTOR","Layer7 PFACTOR","Layer8 PFACTOR","Layer9 PFACTOR","Layer10 PFACTOR","Layer3 Depth","Layer4 Depth","Layer5 Depth","Layer6 Depth","Layer7 Depth","Layer8 Depth","Layer9 Depth","Layer10 Depth" };  //41+9+4 items riceu
